...
const rows = [
  {
    srNo: 1,
    customerName: 'Jigar Kothari',
    quotationDate: '17-10-2019',
    quotationAmount: '4651',
    actions: <div>  <NavLink className="anchor" to={''} size="sm" > Convert To Order </NavLink></div>,
  },
  {
    srNo: 2,
    customerName: 'Aadesh jadhav',
    quotationDate: '17-10-2019',
    quotationAmount: '9963',
    actions:<div>  <NavLink className="anchor" to={''} size="sm" > Convert To Order </NavLink></div>,
  },
]
      ...
      <Layout>
        ...
        <div className="contentpanel">
          <div className="row">
            ...
            <NavLink to='/sales-order-add' className="btn btn-primary" > Add Sales Order </NavLink>
            <MDBDataTable
              striped
              bordered
              hover
