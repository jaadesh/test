...
const rows = [
  
  {
    ...
    quotationAmount: '5450',
    actions: <div><NavLink className="anchor" to={''} size="sm" > Delete </NavLink></div>,
  },
  {
    srNo: 2,
    customerName: 'Jigar Kothari',
    quotationDate: '17-10-2019',
    quotationAmount: '6398',
    actions: <div> <NavLink className="anchor" to={''} size="sm" > Delete </NavLink></div>,
  },
]
      ...
      <Layout>
        ...
        <div className="contentpanel">
          <div className="row">
            ...
            {/*<NavLink to='/invoice-add' className="btn btn-primary" > Add Orders </NavLink> */}
            <MDBDataTable
              striped
              bordered
              hover
